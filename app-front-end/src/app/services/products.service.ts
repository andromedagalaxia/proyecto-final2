...
const URL_LOGIN = 'http://192.168.252.132:5000/login';
const URL_PRODUCTOS = 'http://192.168.252.132:5000/products2';
const URL_PRODUCTOSCATEGORIAS = 'http://192.168.252.132:5000/productCategoria2/';
const URL_PRODUCTOSCRITERIO = 'http://192.168.252.132:5000/search2/';
const URL_PRODUCTOSCODE = 'http://192.168.252.132:5000/productId/';
